export const seo = {
  ...
  description: {
    en: "1-bedroom furnished home in La Ahorcadita, Todos Santos. Off-grid solar, Starlink, and ocean views. 6-month minimum. Available October 1, 2026.",
    es: "Casa amueblada de 1 recámara en La Ahorcadita, Todos Santos. Solar off-grid, Starlink y vistas al océano. Mínimo 6 meses. Disponible el 1 de octubre de 2026.",
  },
  keywords: [
    "Todos Santos rental",
